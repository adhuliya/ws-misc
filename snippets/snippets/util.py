...
LS = False  # never comment this line
"""Logging Switch: default false."""

LS = True   # uncomment this line to make LS false
...
def rename(currName: str, newName: str): # TODO: return False on failure
