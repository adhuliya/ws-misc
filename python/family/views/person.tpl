...
laboris nisi ut aliquip ex ea commodo consequat.
  ...
  <div class="w3-padding-32 w3-content w3-text-grey" id="contact" style="margin-bottom:64px">
    ...
    <form action="/action_page.php" target="_blank">
      ...
      <p><input class="w3-input w3-padding-16 w3-border" placeholder="Subject" required="" name="Subject" type="text"></p>
      <p><input class="w3-input w3-padding-16 w3-border" placeholder="Message" required="" name="Message" type="text"></p>
      <p>
