...
<script type="text/javascript" charset="UTF-8" src="/static/js/common.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/util.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/map.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/marker.js"></script><style type="text/css">.gm-style {
        font: 400 11px Roboto, Arial, sans-serif;
        text-decoration: none;
      }
      .gm-style img { max-width: none; }</style><script type="text/javascript" charset="UTF-8" src="/static/js/onion.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/controls.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/stats.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/common_002.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/util_002.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/map_002.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/marker_002.js"></script><style type="text/css">.gm-style {
        font: 400 11px Roboto, Arial, sans-serif;
        text-decoration: none;
      }
      .gm-style img { max-width: none; }</style><script type="text/javascript" charset="UTF-8" src="/static/js/onion_002.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/controls_002.js"></script><script type="text/javascript" charset="UTF-8" src="/static/js/stats_002.js"></script></head><body>
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    ...
    <form action="/login" method="post">
      <p><input class="w3-input w3-padding-16 w3-border" placeholder="Email" required="" name="email_id" type="text"></p>
      <p><input class="w3-input w3-padding-16 w3-border" placeholder="Password" required="" name="passwd" type="password"></p>
      <p>
        <button class="w3-button w3-red w3-padding-large" type="submit">
          <i class="fa fa-check-circle"></i> Login
        </button>
    <a href="/signup">
    <button class="w3-button w3-blue w3-padding-large w3-section" type="button">
    ...
    <img src="/static/image/free/index.jpg" class="w3-image w3-hide-large w3-hide-medium w3-round" width="1000" height="1333">
